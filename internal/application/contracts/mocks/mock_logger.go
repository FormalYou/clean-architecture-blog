...
// Source: internal/application/contracts/logger.go
//
// Generated by this command:
//
//	mockgen -source=internal/application/contracts/logger.go -destination=internal/application/contracts/mocks/mock_logger.go -package=mocks
//
